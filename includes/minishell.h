...
/*   Updated: 2021/06/03 16:17:36 by jurichar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				exec_built_in (t_lst *lst, t_env_lst *envlst);
void			get_built_in (t_lst *lst, t_env_lst *envlst);
...
int				builtin_env(t_lst *lst, t_env_lst *envlst);
